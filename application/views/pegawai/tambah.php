                ...
                <div class="card-body">
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="id_pegawai" placeholder="Masukkan ID Pegawai" class="form-control">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="nama" placeholder="Masukkan Nama Pegawai" class="form-control">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="telepon" id="telepon" placeholder="Masukkan Nomor Telepon" class="form-control">
                            <div class="form-text text-danger"><?= form_error('telepon'); ?></div>
                        </div>

                        <div class="form-group mt-3">
                            <label for="agama">Agama</label>
                            <input type="text" name="agama" id="agama" placeholder="Masukkan Agama" class="form-control">
                        ...
                        <div class="form-group mt-3">
                            ...
                            <input type="text" name="alamat" id="alamat" placeholder="Masukkan Nomor Alamat" class="form-control">
                            <div class="form-text text-danger"><?= form_error('alamat'); ?></div>
                        </div>

                        <div class="form-group mt-3">
                            <label for="id_golongan">ID Golongan</label>
                            <input type="text" name="id_golongan" id="id_golongan" placeholder="Masukkan ID Golongan" class="form-control">
